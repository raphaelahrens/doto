...
class Section(object):
    ...
    class SectionIterator(object):
        ...
        def __init__(self, value_dict):
            self.__iterator = value_dict.iteritems()
    ...
    def __init__(self, value_dict):
        self.__values = {name: Value(values) for name, values in value_dict.iteritems()}
...
class Config(object):
    ...
    def __init__(self, config_file, defaults):
        self.__sections = {name: Section(values) for name, values in defaults.iteritems()}
    ...
    def print_config(self):
        ...
        """
        parser = ConfigParser.SafeConfigParser()
        for s_name, section in self.__sections.iteritems():
